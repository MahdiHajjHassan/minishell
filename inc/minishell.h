...
void	copy_and_update_env_vars(char ***env_copy, char **new_environ, char *old_pwd_var, char *new_pwd_var);
void	finalize_new_environ_pwd(char **new_environ, int count, char *old_pwd_var, char *new_pwd_var);
...
int				create_first_child(int *p, struct s_pipecmd *pipecmd, char **env_copy);
int				create_second_child(int *p, struct s_pipecmd *pipecmd, char **env_copy, pid_t pid1);
...
int				update_existing_var(char ***env_copy, int i, const char *name, const char *value);
int				count_env_vars(char ***env_copy);
int				allocate_new_environ(char ***env_copy, char **new_var, char ***new_environ);
void			copy_existing_env_vars(char ***env_copy, char **new_environ, int count);
void			finalize_new_environ(char **new_environ, int count, char *new_var, char ***env_copy);
int				add_new_var(char ***env_copy, const char *name, const char *value);
int				count_total_vars(char ***env_copy);
void			copy_vars_except_index(char ***env_copy, char **new_environ, int var_index);
