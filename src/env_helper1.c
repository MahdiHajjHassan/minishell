...
static char	*handle_exit_status_var(void)
{
	char	*status_str;
...
static char	*search_env_variable(const char *name, size_t name_len,
...
static int	handle_env_value_found(t_env_var_params params, char *env_value,
...
static int	handle_env_value_not_found(t_env_var_params params,
		size_t var_name_len)
{
